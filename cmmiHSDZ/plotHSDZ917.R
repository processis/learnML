...
gScatterPlotMDit <- ggplot(HSDZ913, aes(x = AfpDev , y = ManDayIt))
gScatterPlotMDit + geom_point(aes(color = Project))

gScatterPlotLnJavaSize <- ggplot(HSDZ913, aes(x = AfpDev , y = LnJavaIt))
gScatterPlotLnJavaSize + geom_point(aes(color = Project))

gScatterPlotVueSize <- ggplot(HSDZ913, aes(x = AfpDev , y = X.1))
gScatterPlotVueSize + geom_point(aes(color = Project))

gScatterPlotVueIt <- ggplot(HSDZ913, aes(x = AfpDev , y = LocVUEit))
gScatterPlotVueIt + geom_point(aes(color = Project))

gScatterPlotTstCasesTot <- ggplot(HSDZ913, aes(x = AfpDev , y = TestCasesTotal))
gScatterPlotTstCasesTot + geom_point(aes(color = Project))

gScatterPlotDefCount <- ggplot(HSDZ913, aes(x = AfpDev , y = DefectCount))
gScatterPlotDefCount + geom_point(aes(color = Project))
